...
pub const VK_FORMAT_INFO_TABLE: &[VkFormatInfo] = &[
    ...
    // BGRA_102LE
    finfo!(BGRA_102LE, A2R10G10B10, SINT, _PACK32),
    finfo!(BGRA_102LE, A2R10G10B10, SNORM, _PACK32),
    finfo!(BGRA_102LE, A2R10G10B10, SSCALED, _PACK32),
    finfo!(BGRA_102LE, A2R10G10B10, UINT, _PACK32),
    finfo!(BGRA_102LE, A2R10G10B10, UNORM, _PACK32),
    finfo!(BGRA_102LE, A2R10G10B10, USCALED, _PACK32),
    // RGBA_F16
    finfo!(RGBA_F16, R16G16B16A16, SFLOAT),
    // RGBA_F32
    finfo!(RGBA_F32, R32G32B32A32, SFLOAT),
    // GRAY16
